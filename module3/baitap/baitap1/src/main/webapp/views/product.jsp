        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="${urlServlet}">Home</a>
                    </li>
<%--                    <li class="nav-item">--%>
...
<%--                    </li>--%>
                ...
                <form action="${urlServlet}" class="d-flex input-group w-auto" method="get">
    ...
    <div class="p-5 text-center bg-light" style="margin-top: 8px;">
            ...
            <c:forEach items="${list}" var="item" varStatus="loop">
                <tr>
                    ...
                    <c:forEach var="category" items="${categoryList}">
                        <c:if test="${item.category == category.id}">
                            <td>${category.name}</td>
                        </c:if>
                    </c:forEach>
        ...
        <nav aria-label="...">
            <ul class="pagination">
                ...
                <c:if test="${index != 1}">
                    <li class="page-item ">
                        <a class="page-link" href="/productServlet?index=${index - 1}">Previous</a>
                    </li>
                </c:if>

                <c:forEach begin="1" end="${pages}" var="item">
                    <li class="${index == item ? "page-item active" : "page-item"}">
                        <a class="page-link" href="/productServlet?index=${item}">${item}</a>
                    </li>
                </c:forEach>
                ...
                <c:if test="${index != pages}">
                    <li class="page-item ">
                        <a class="page-link" href="/productServlet?index=${index + 1}">Next</a>
                    </li>
                </c:if>
            </ul>
        </nav>
